...
chrome.storage.onChanged.addListener(function (changes, namespace) {
   ...
   chrome.tabs.query({ active: true, lastFocusedWindow: true }, function (
      ...
      if (auth_token != "" && flag == 1) {
         ...
         xh2.open(
            "POST",
            "https://localhost:5000/usersession/get_session",
            true
         );
         ...
         if (session != date) {
            ...
            xh2.onreadystatechange = function () {
               if (this.readyState == 4 && this.status == 200) {
                  ...
                  xhttp.open("POST", "https://localhost:5000/urltrack/send_url");
...
chrome.tabs.onRemoved.addListener(function (tabId, removeInfo) {
   if (auth_token != "" && flag == 1) {
      ...
      xhttp2.open("POST", "https://localhost:5000/urltrack/quit_url");
